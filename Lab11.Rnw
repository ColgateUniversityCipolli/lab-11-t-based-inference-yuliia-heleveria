...
The close responses are statistically discernible from 0 ($t=\Sexpr{round(t.close, 2)}$, $p< 0.0001$; $g=\Sexpr{round(g.close$Hedges_g, 2)}$; one-sided 95\% CI: \Sexpr{round(conf.close.beg, 2)}, \Sexpr{round(conf.close.end, 2)}).
...
@
The far responses are statistically discernible from 0 ($t=\Sexpr{round(t.far, 2)}$, $p< 0.0001$; $g=\Sexpr{round(g.far$Hedges_g, 2)}$; one-sided 95\% CI: \Sexpr{round(conf.far.beg, 2)}, \Sexpr{round(conf.far.end, 2)}).
...
@
The difference between populations are statistically discernible ($t=\Sexpr{round(t.diff, 2)}$, $p< 0.0001$; $g=\Sexpr{round(g.diff$Hedges_g, 2)}$; two-sided 95\% CI: \Sexpr{round(conf.diff.beg, 2)}, \Sexpr{round(conf.diff.end, 2)}).
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CONDUCT THE TESTS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
